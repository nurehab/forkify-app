...
const controlAddRecipe = async function(newRecipe) {
    try {
        ...
        }, (0, _configJs.CLOSE_WINDOW_SEC) * 1000);
    } catch (err) {
        console.error("\uD83D\uDCA5", err);
...
},{"core-js/modules/web.immediate.js":"bzsBv","./model.js":"3QBkH","./views/recipeView.js":"3wx5k","./views/searchView.js":"kbE4Z","regenerator-runtime/runtime":"f6ot0","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./views/resultsView.js":"kBQ4r","./views/paginationView.js":"7NIiB","./views/bookmarksView.js":"1qGeA","./views/addRecipeView.js":"8AWnP","./config.js":"2hPh4"}],"bzsBv":[function(require,module,exports,__globalThis) {
'use strict';
...
const loadRecipe = async function(id) {
    try {
        ...
        const data = await (0, _helperJs.AjaxCall)(`${(0, _configJs.API_URL)}${id}?key=${(0, _configJs.KEY)}`);
...
const loadSearchResults = async function(query) {
    try {
        ...
        const data = await (0, _helperJs.AjaxCall)(`${(0, _configJs.API_URL)}?search=${query}&key=${(0, _configJs.KEY)}`);
...
const uploadRecipe = async function(newRecipe) {
    try {
        ...
        const ingredients = Object.entries(newRecipe).filter((entry)=>entry[0].startsWith('ingredient') && entry[1] !== '').map((ing)=>{
            ...
            if (!description) throw new Error('Description is required for each ingredient!');
        ...
        // Post data to API :
        const data = await (0, _helperJs.AjaxCall)(`${(0, _configJs.API_URL)}?key=${(0, _configJs.KEY)}`, recipe);
...
const KEY = '4e49cbb6-650d-415c-a84d-43de28c3741e';
...
parcelHelpers.export(exports, "eventDelegation", ()=>eventDelegation);
var _configJs = require("./config.js");
...
const AjaxCall = async function(url, uploadData) {
    try {
        const res = uploadData ? await Promise.race([
            fetch(url, {
                method: 'POST',
...
const eventDelegation = function(element) {
...
class PaginationView extends (0, _viewJsDefault.default) {
    ...
    _generateMarkup() {
        ...
        const numsOfPages = Math.ceil(this._data.results.length / this._data.resultsPerPage);
        // page 1, and there are other pages
        if (currentPage === 1 && numsOfPages > 1) return `
      ...
      `;
        // last page
        if (currentPage === numsOfPages && numsOfPages > 1) return `
      ...
      `;
        //other page
        if (currentPage < numsOfPages) return `
        <button data-go-to-page="${currentPage - 1}" class="btn--inline pagination__btn--prev">
          <svg class="search__icon">
            <use href="${0, _iconsSvgDefault.default}#icon-arrow-left"></use>
          </svg>
